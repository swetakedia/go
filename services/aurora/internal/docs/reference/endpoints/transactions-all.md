...
This endpoint can also be used in [streaming](../streaming.md) mode. This makes it possible to use it to listen for new transactions as they get made in the Hcnet network.
